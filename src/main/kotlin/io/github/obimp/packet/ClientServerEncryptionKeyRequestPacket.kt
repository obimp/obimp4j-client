...
import io.github.obimp.packet.handle.im.InstantMessagingPacketHandler.Companion.OBIMP_BEX_IM_CLI_SRV_ENCRYPT_KEY_REQ
 ...
 */
class ClientServerEncryptionKeyRequestPacket(accountName: String) : Packet<WTLD> {
    override var header: Header = OBIMPHeader(type = OBIMP_BEX_IM, subtype = OBIMP_BEX_IM_CLI_SRV_ENCRYPT_KEY_REQ)
