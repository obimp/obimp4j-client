...
import io.github.obimp.packet.handle.cl.ContactListPacketHandler.Companion.OBIMP_BEX_CL_CLI_SRV_AUTH_REVOKE
...
class ClientServerAuthRevokePacket(
    ...
    override var header: Header = OBIMPHeader(type = OBIMP_BEX_CL, subtype = OBIMP_BEX_CL_CLI_SRV_AUTH_REVOKE)
