...
import io.github.obimp.packet.handle.cl.ContactListPacketHandler.Companion.OBIMP_BEX_CL_CLI_VERIFY
 ...
 */
class ClientContactListVerifyPacket : Packet<WTLD> {
    override var header: Header = OBIMPHeader(type = OBIMP_BEX_CL, subtype = OBIMP_BEX_CL_CLI_VERIFY)
