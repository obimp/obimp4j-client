 ...
 */
class ClientServerKeepalivePongPacket : Packet<WTLD> {
    override var header: Header = OBIMPHeader(type = OBIMP_BEX_COM, subtype = OBIMP_BEX_COM_CLI_SRV_KEEPALIVE_PONG)
