 ...
 */
class ClientUserAvatarRequestPacket(avatarFileMD5Hash: ByteArray, transportItemID: Int? = null) : Packet<WTLD> {
    override var header: Header = OBIMPHeader(type = OBIMP_BEX_UA, subtype = OBIMP_BEX_UA_CLI_AVATAR_REQ)
